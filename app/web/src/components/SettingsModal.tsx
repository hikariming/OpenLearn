            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] max-h-[800px] flex overflow-hidden border border-gray-100">
                        ...
                        {menuItems.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 group ${isActive
                ...
                <div className="flex-1 flex flex-col min-w-0 bg-[#FAFAFA] relative">
                    ...
                    <div className="flex-1 overflow-y-auto p-8">
                        {message && (
                            <div
                                className={`mb-6 p-4 rounded-lg flex items-center gap-2 text-sm font-medium animate-in fade-in slide-in-from-top-2 ${message.type === 'success'
